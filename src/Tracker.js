                        ...
                        <div className="uk-width-1-1">
                            <div className='uk-padding'>
                                ...
                                <div className='uk-width-1-1@m uk-margin-large'>
                                    ...
                                    {this.state.ticket.status !== 6 && <a href={'/update/' + this.state.ticket._id}  className="uk-button uk-margin-right orange_btn">Update Job ticket</a>}
                                    {this.state.ticket.status !== 6 && <a  href={'/part-order/' + this.state.ticket._id} className="uk-button uk-margin-right blue_btn">Make Part Order</a>}
